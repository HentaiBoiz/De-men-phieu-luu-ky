...
{
    public partial class Level_5_2 : Form
    {
        ...
        int dropTime_1 = 50, dropTime_2 = 10, dropTime_3 = 5;
        bool willDrop_1 = false, willDrop_2 = false, willDrop_3 = false;
        ...
        private void MainTimeEvents(object sender, EventArgs e)
        {
            ...
            foreach (Control x in this.Controls)
            {
                ...
                if (x is PictureBox && (string)x.Tag == "nextForm")
                {
                    ...
                    {
                        GameTimer.Stop();
                        Program.AutoSave(score, "Final");
                        CutScene_5 newWindow = new CutScene_5();
                        newWindow.Show();
                        this.Hide();
                    }
                    ...
                    if (x.Name == "KienLua_1")
                    {
                        ...
                        foreach (Control y in this.Controls)
                        {
                            if (y is PictureBox && (string)y.Tag == "platform"
                                || y is PictureBox && (string)y.Tag == "platform_dropdown")
                            {
        ...
        private void Level_5_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void MoveGameElement(string direction)
        {
            foreach (Control x in this.Controls)
            {
                if (x is PictureBox && (string)x.Tag == "platform"
                    ...
                    || x is PictureBox && (string)x.Tag == "chiNhaTro"
        ...
        private void RestartGame()
        {
            ResetDuLieu();
            sndBackgroundTheme.PlayLooping();
            Level_5_2 newWindow = new Level_5_2(score_);
            newWindow.Show();
            this.Hide();
        }
