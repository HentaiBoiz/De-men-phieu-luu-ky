...
{
    public partial class Level_5_1 : Form
    {
        ...
        private int giunTime_1 = 120, giunTime_2 = 110;
        private int kienLuaSpeed_1 = KienLuaGobalSpeed-2, kienLuaSpeed_2 = KienLuaGobalSpeed;

        //Platform tự rơi
        private int droppingPlatSpeed = 4;
        private int dropTime_1 = 50, dropTime_2 = 70;
        private bool willDrop_1 = false, willDrop_2 = false;
        ...
        private void MainTimeEvents(object sender, EventArgs e)
        {
            ...
            foreach (Control x in this.Controls)
            {
                ...
                if (x is PictureBox && (string)x.Tag == "nextForm")
                {
                    ...
                    {
                        GameTimer.Stop();
                        Level_5_2 newWindow = new Level_5_2(score);
                        newWindow.Show();
                        this.Hide();
                    }
        ...
        private void Level5_Paint(object sender, PaintEventArgs e)
        {
